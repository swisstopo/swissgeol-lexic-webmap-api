...
import type { VocabularyLanguage } from "../../data/mockData";
import type { GraphDbVocabularyLabel } from "../../graphdb/types";
 ...
 * requested language, then English, then optional untagged or configured fallback.
 */
