...
import { getGraphDbVocabularyDefinition } from "../../../services/graphdb/vocabularyDefinitionRegistry";
...
export const buildVocabularyQueryConfig = (uriSegment: string): VocabularyQueryConfig => ({
  allConcept:
