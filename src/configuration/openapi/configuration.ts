 ...
 */
export const OPENAPI_SPEC_FILENAME = "SwissTopoWebmapAPI-1.6.2.yaml";
...
/**
 * Resolves the bundled OpenAPI specification path from the application root.
 *
 * Runtime startup, Swagger UI serving, and validator initialization all use this
 * path so there is one configured OpenAPI source for the HTTP boundary.
 */
 ...
 *
 * Failing here keeps bootstrap errors explicit before the server starts
 * accepting requests.
 */
